...
/**
 * @method \Sherlock\components\filters\Raw Raw() Raw(\string $json)

 */
class Raw extends \Sherlock\components\BaseComponent implements \Sherlock\components\FilterInterface
{
    /**
    ...
    {
        if (!isset($hashMap)) {
            throw new exceptions\BadMethodCallException("Hashmap must be provided for the Raw filter");
        }
