...
namespace sherlock\tests\components\queries\MultiMatch;

use sherlock\components\queries\MultiMatch;
...
class MatchTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testBuild()
	{
		...
		$this->assertInstanceOf('sherlock\components\queries\MultiMatch', $ret);
